...
class Config():
  ...
  BOT_TOKEN = os.environ.get("BOT_TOKEN", "#") #Removed thr # and put bot token
  ...
  DATABASE_URL = os.environ.get("DATABASE_URL", "#") #Remove the # and put Database URl
  # get it from my.telegram.org
  APP_ID = os.environ.get("APP_ID", #) #Remove the # and put API ID
  API_HASH = os.environ.get("API_HASH", "#") Remove the # and put API_HASH
  # Sudo users( goto @JVToolsBot and send /id to get your id)
  SUDO_USERS = list(set(int(x) for x in os.environ.get("SUDO_USERS", "#").split()))  #Remove the # and put sudo user id
  SUDO_USERS.append(#) #Remove the # and put sudo user id here too
